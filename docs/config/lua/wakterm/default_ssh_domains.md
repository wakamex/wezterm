---
title: wakterm.default_ssh_domains
tags:
 - ssh
 - multiplexing
---
...
require wakterm to be installed on the remote host, while the
...
are unix machines, you might want to inform wakterm of that
