...
# `wakterm.log_error(arg, ..)`

This function logs the provided message string through wakterm's logging layer
at 'ERROR' level, which can be displayed via [ShowDebugOverlay](../keyassignment/ShowDebugOverlay.md) action.  If you started wakterm from a terminal that text will print
