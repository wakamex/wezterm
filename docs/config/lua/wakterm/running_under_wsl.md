---
title: wakterm.running_under_wsl
tags:
 - utility
---
# `wakterm.running_under_wsl()`
...
environment the `wakterm.target_triple` will indicate that we are running in
...
wakterm.log_error(
  'System '
    ...
    .. ' '
    .. tostring(wakterm.running_under_wsl())
)
```
