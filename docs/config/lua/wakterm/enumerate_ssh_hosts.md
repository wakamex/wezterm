---
title: wakterm.enumerate_ssh_hosts
tags:
 - ssh
---
...
list as though
[wakterm.add_to_config_reload_watch_list()](add_to_config_reload_watch_list.md)
...
for host, config in pairs(wakterm.enumerate_ssh_hosts()) do
  table.insert(ssh_domains, {
    ...
    -- if you don't have wakterm's mux server installed on the remote
