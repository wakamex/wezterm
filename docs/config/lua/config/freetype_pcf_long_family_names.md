...
## Why doesn't wakterm use the distro FreeType or match its configuration?

For the sake of consistency, wakterm vendors in its own copy of
...
version of wakterm are the same on all platforms regardless of
