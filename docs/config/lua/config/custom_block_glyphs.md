...
|[Git Branch Symbols](https://github.com/wakamex/wakterm/issues/6328)|Custom branch drawing symbols for rendering DAGs such as Git branch structure|{{since('nightly', inline=True)}}|
