...
In this mode, if the application hasn't enabled mouse reporting, wakterm will
...
In versions of wakterm prior to this configuration option being available, the
