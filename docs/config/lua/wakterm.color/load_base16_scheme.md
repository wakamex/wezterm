...
Note that wakterm ships with the base16 color schemes that were referenced via
...
that was created after your version of wakterm was built.
...
```
> colors, metadata = wakterm.color.load_base16_scheme("/tmp/cupcake.yaml")
> print(colors)
