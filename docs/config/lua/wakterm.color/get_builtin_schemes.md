...
local schemes = {}
for name, scheme in pairs(wakterm.color.get_builtin_schemes()) do
...
local scheme = wakterm.color.get_builtin_schemes()['Gruvbox Light']
...
local function dark_schemes()
  local schemes = wakterm.color.get_builtin_schemes()
  local dark = {}
