...
* `active` - contains information about the *active* screen. The active screen is the one which has input focus. On some systems, wakterm will return the same information as the `main` screen screen.
