...
* Querying the path may fail for a variety of reasons outside of the control of wakterm
* Querying process information has some runtime overhead, which may cause wakterm to slow down if over-used.
