...
*wakterm is an actively maintained fork of <a href="https://github.com/wezterm/wezterm">WezTerm</a>, the cross-platform terminal emulator and multiplexer written by <a href="https://github.com/wez/">@wez</a> in <a href="https://www.rust-lang.org/">Rust</a>. This fork focuses on mux reliability, persistent layouts, and first-class agent harness support.*
...
* Claude, Codex, Gemini, and OpenCode work as first-class agent harness panes
