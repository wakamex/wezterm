fn main() {
    ...
    #[cfg(windows)]
    {
        ...
        // version number that we report in wakterm -h.
...
BEGIN
    ...
    BEGIN
        ...
        BEGIN
            ...
            VALUE "FileDescription",  "wakterm terminal emulator and multiplexer\0"
            VALUE "FileVersion",      "{version}\0"
            VALUE "LegalCopyright",   "Wez Furlong, MIT licensed\0"
            VALUE "InternalName",     "\0"
            VALUE "OriginalFilename", "\0"
            VALUE "ProductName",      "wakterm\0"
...
"#,
    ...
    #[cfg(target_os = "macos")]
    {
        ...
        println!("cargo:rerun-if-changed=assets/macos/wakterm.app/Contents/Info.plist");
