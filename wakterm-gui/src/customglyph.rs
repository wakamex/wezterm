...
pub const HARNESS_ICON_CLAUDE: char = '\u{e000}';
...
pub const HARNESS_ICON_OPENCODE_POLY: &[Poly] = &[
    Poly {
        path: &[
            PolyCommand::MoveTo(BlockCoord::SquareFrac(12, 120), BlockCoord::SquareZero),
            PolyCommand::LineTo(BlockCoord::SquareFrac(108, 120), BlockCoord::SquareZero),
