...
use wakterm_blob_leases::{BlobLease, BlobManager, BoxedReader};
use wakterm_font::units::*;
use wakterm_font::{FontConfiguration, GlyphInfo, LoadedFont, LoadedFontId};
use wakterm_term::Underline;
...
impl GlyphCache {
    ...
    fn load_glyph(
        ...
        // can happen somehow; see <https://github.com/wakamex/wakterm/issues/1042>
        ...
        match &*handle.h {
            ...
            ImageDataType::AnimRgba8 {
                ...
                if frames.len() > 1 {
                    ...
                    // frame duration that wakterm can use when rendering.
                    ...
                    // <https://github.com/wakamex/wakterm/issues/3260>
