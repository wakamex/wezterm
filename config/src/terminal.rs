...
use wakterm_term::config::BidiMode;
...
impl wakterm_term::TerminalConfiguration for TermConfig {
    ...
    fn canonicalize_pasted_newlines(&self) -> wakterm_term::config::NewlineCanon {
        match self.configuration().canonicalize_pasted_newlines {
            None => wakterm_term::config::NewlineCanon::default(),
            Some(NewlineCanon::None) => wakterm_term::config::NewlineCanon::None,
            Some(NewlineCanon::LineFeed) => wakterm_term::config::NewlineCanon::LineFeed,
            Some(NewlineCanon::CarriageReturn) => {
                wakterm_term::config::NewlineCanon::CarriageReturn
            }
            Some(NewlineCanon::CarriageReturnAndLineFeed) => {
                wakterm_term::config::NewlineCanon::CarriageReturnAndLineFeed
            }
        }
    }
