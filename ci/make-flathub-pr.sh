...
URL="https://github.com/wakamex/wakterm/releases/download/${TAG_NAME}/wakterm-${TAG_NAME}-src.tar.gz"
...
SHA256=$(sha256sum wakterm*-src.tar.gz | cut -d' ' -f1)

sed -e "s,@URL@,$URL,g" -e "s/@SHA256@/$SHA256/g" < assets/flatpak/org.wezfurlong.wakterm.template.json > flathub/org.wezfurlong.wakterm.json
