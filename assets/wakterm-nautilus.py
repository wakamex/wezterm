...
class OpenInWakTermAction(GObject.GObject, Nautilus.MenuProvider):
    def __init__(self):
        super().__init__()
    ...
    def _make_item(self, name, paths):
        item = Nautilus.MenuItem(name=name, label='Open in wakterm',
            icon='org.wezfurlong.wakterm')
    ...
    def get_file_items(self, *args):
        ...
        if paths:
            return [self._make_item(name='WakTermNautilus::open_in_wakterm', paths=paths)]
        else:
            return []
    ...
    def get_background_items(self, *args):
        ...
        if paths:
            return [self._make_item(name='WakTermNautilus::open_folder_in_wakterm', paths=paths)]
        else:
            return []
