...
use wakterm_cell::color::ColorAttribute;
#[cfg(feature = "use_image")]
use wakterm_cell::image::ImageCell;
...
mod test {
    use super::*;
    use alloc::sync::Arc;
    use wakterm_cell::color::AnsiColor;
    use wakterm_cell::image::ImageData;
    use wakterm_cell::{AttributeChange, Intensity};
