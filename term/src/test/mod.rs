...
use wakterm_escape_parser::csi::{Edit, EraseInDisplay, EraseInLine};
use wakterm_escape_parser::{OneBased, OperatingSystemCommand, CSI};
use wakterm_surface::{CursorShape, CursorVisibility, SequenceNo, SEQ_ZERO};
...
fn test_semantic_1539() {
    use wakterm_escape_parser::osc::FinalTermSemanticPrompt;
...
fn test_scroll_margins() {
    ...
    let margins = CSI::Cursor(wakterm_escape_parser::csi::Cursor::SetTopAndBottomMargins {
        top: OneBased::new(1),
